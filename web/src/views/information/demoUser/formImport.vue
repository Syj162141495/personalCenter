...
<script lang="ts" setup>
  ...
  import { demoUserImportData } from '/@/api/information/demoUser';
  ...
  async function handleDownloadTemplate() {
    ...
    downloadByUrl({ url: ctxAdminPath + '/information/demoUser/importTemplate' });
  }
  ...
  async function handleSubmit() {
    try {
      ...
      const { data } = await demoUserImportData(params, onUploadProgress);
